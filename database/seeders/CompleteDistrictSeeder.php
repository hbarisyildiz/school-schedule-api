...
class CompleteDistrictSeeder extends Seeder
{
    public function run()
    {
        ...
        $allDistricts = [
            ...
            'Afyonkarahisar' => [
                'Afyonkarahisar Merkez', 'Başmakçı', 'Bayat', 'Bolvadin', 'Çay', 'Çobanlar', 'Dazkırı', 
                'Dinar', 'Emirdağ', 'Evciler', 'Hocalar', 'İhsaniye', 'İscehisar', 'Kızılören', 
            ...
            'Artvin' => [
                'Ardanuç', 'Arhavi', 'Artvin Merkez', 'Borçka', 'Hopa', 'Murgul', 'Şavşat', 'Yusufeli'
            ],
            'Aydın' => [
            ...
            'Bingöl' => [
                'Adaklı', 'Bingöl Merkez', 'Genç', 'Karlıova', 'Kiğı', 'Solhan', 'Yayladere', 'Yedisu'
            ],
            'Bitlis' => [
                'Adilcevaz', 'Ahlat', 'Bitlis Merkez', 'Güroymak', 'Hizan', 'Mutki', 'Tatvan'
            ],
            'Bolu' => [
                'Bolu Merkez', 'Dörtdivan', 'Gerede', 'Göynük', 'Kıbrıscık', 'Mengen', 'Mudurnu', 
                'Seben', 'Yeniçağa'
            ],
            'Burdur' => [
                'Ağlasun', 'Altınyayla', 'Bucak', 'Burdur Merkez', 'Çavdır', 'Çeltikçi', 'Gölhisar', 
            ...
            'Çanakkale' => [
                'Ayvacık', 'Bayramiç', 'Biga', 'Bozcaada', 'Çan', 'Çanakkale Merkez', 'Eceabat', 
                'Ezine', 'Gelibolu', 'Gökçeada', 'Lapseki', 'Yenice'
            ],
            'Çankırı' => [
                'Atkaracalar', 'Bayramören', 'Çankırı Merkez', 'Çerkeş', 'Eldivan', 'Ilgaz', 
                'Kızılırmak', 'Korgun', 'Kurşunlu', 'Orta', 'Şabanözü', 'Yapraklı'
            ],
            'Çorum' => [
                'Alaca', 'Bayat', 'Boğazkale', 'Çorum Merkez', 'Dodurga', 'İskilip', 'Kargı', 
            ...
            'Diyarbakır' => [
                ...
                'Hani', 'Hazro', 'Kocaköy', 'Kulp', 'Lice', 'Silvan', 'Sur', 'Yenişehir'
            ],
            'Edirne' => [
                'Edirne Merkez', 'Enez', 'Havsa', 'İpsala', 'Keşan', 'Lalapaşa', 'Meriç', 'Süloğlu', 'Uzunköprü'
            ],
            'Elazığ' => [
                'Ağın', 'Alacakaya', 'Arıcak', 'Baskil', 'Elazığ Merkez', 'Karakoçan', 'Keban', 
                'Kovancılar', 'Maden', 'Palu', 'Sivrice'
            ],
            'Erzincan' => [
                'Çayırlı', 'Erzincan Merkez', 'İliç', 'Kemah', 'Kemaliye', 'Otlukbeli', 'Refahiye', 
                'Tercan', 'Üzümlü'
            ],
            'Erzurum' => [
            ...
            'Giresun' => [
                ...
                'Eynesil', 'Giresun Merkez', 'Görele', 'Güce', 'Keşap', 'Piraziz', 'Şebinkarahisar', 
                'Tirebolu', 'Yağlıdere'
            ],
            'Gümüşhane' => [
            ...
            'Isparta' => [
                'Aksu', 'Atabey', 'Eğirdir', 'Gelendost', 'Gönen', 'Isparta Merkez', 'Keçiborlu', 
            ...
            'Kars' => [
                'Akyaka', 'Arpaçay', 'Digor', 'Kağızman', 'Kars Merkez', 'Sarıkamış', 'Selim', 'Susuz'
            ],
            'Kastamonu' => [
                'Abana', 'Ağlı', 'Araç', 'Azdavay', 'Bozkurt', 'Cide', 'Çatalzeytin', 'Daday', 
                'Devrekani', 'Doğanyurt', 'Hanönü', 'İhsangazi', 'İnebolu', 'Kastamonu Merkez', 
                'Küre', 'Pınarbaşı', 'Seydiler', 'Şenpazar', 'Taşköprü', 'Tosya'
            ],
            'Kayseri' => [
            ...
            'Kırklareli' => [
                'Babaeski', 'Demirköy', 'Kırklareli Merkez', 'Kofçaz', 'Lüleburgaz', 'Pehlivanköy', 
                'Pınarhisar', 'Vize'
            ],
            'Kırşehir' => [
                'Akçakent', 'Akpınar', 'Boztepe', 'Çiçekdağı', 'Kaman', 'Kırşehir Merkez', 'Mucur'
            ],
            'Kocaeli' => [
            ...
            'Konya' => [
                ...
                'Tuzlukçu', 'Vulkan', 'Yalıhüyük', 'Yunak'
            ],
            'Kütahya' => [
                'Altıntaş', 'Aslanapa', 'Çavdarhisar', 'Domaniç', 'Dumlupınar', 'Emet', 'Gediz', 
                'Hisarcık', 'Kütahya Merkez', 'Pazarlar', 'Simav', 'Şaphane', 'Tavşanlı'
            ],
            'Malatya' => [
            ...
            'Nevşehir' => [
                'Acıgöl', 'Avanos', 'Derinkuyu', 'Gülşehir', 'Hacıbektaş', 'Kozaklı', 'Nevşehir Merkez', 'Ürgüp'
            ],
            'Niğde' => [
                'Altunhisar', 'Bor', 'Çamardı', 'Çiftlik', 'Niğde Merkez', 'Ulukışla'
            ],
            'Ordu' => [
                'Akkuş', 'Altınordu', 'Aybasti', 'Çamaş', 'Çatalpınar', 'Çaybaşı', 'Fatsa', 
            ...
            'Rize' => [
                ...
                'Hemşin', 'İkizdere', 'İyidere', 'Kalkandere', 'Pazar', 'Rize Merkez'
            ],
            'Sakarya' => [
            ...
            'Tokat' => [
                ...
                'Sulusaray', 'Tokat Merkez', 'Turhal', 'Yeşilyurt', 'Zile'
            ],
            'Trabzon' => [
            ...
            'Yozgat' => [
                ...
                'Kadışehri', 'Saraykent', 'Sarıkaya', 'Sorgun', 'Şefaatli', 'Yenifakılı', 
                'Yerköy', 'Yozgat Merkez'
            ],
            'Zonguldak' => [
                'Alaplı', 'Çaycuma', 'Devrek', 'Gökçebey', 'Kilimli', 'Kozlu', 'Zonguldak Merkez'
            ],
            'Aksaray' => [
                'Ağaçören', 'Aksaray Merkez', 'Eskil', 'Gülağaç', 'Güzelyurt', 'Ortaköy', 'Sarıyahşi'
            ],
            'Bayburt' => [
            ...
            'Kırıkkale' => [
                'Bahşili', 'Balışeyh', 'Çelebi', 'Delice', 'Karakeçili', 'Keskin', 'Kırıkkale Merkez', 
                'Sulakyurt', 'Yahşihan'
            ],
            'Batman' => [
            ...
            'Şırnak' => [
                'Beytüşşebap', 'Cizre', 'Güçlükonak', 'İdil', 'Silopi', 'Şırnak Merkez', 'Uludere'
            ],
            'Bartın' => [
            ...
            'Osmaniye' => [
                'Bahçe', 'Düziçi', 'Hasanbeyli', 'Kadirli', 'Osmaniye Merkez', 'Sumbas', 'Toprakkale'
            ],
            'Düzce' => [
                'Akçakoca', 'Cumayeri', 'Çilimli', 'Düzce Merkez', 'Gölyaka', 'Gümüşova', 'Kaynaşlı', 'Yığılca'
            ]
        ];

        foreach ($allDistricts as $cityName => $districts) {
            ...
            foreach ($districts as $districtName) {
                District::updateOrCreate(
                    ['city_id' => $cityId, 'name' => $districtName],
                    ['city_id' => $cityId, 'name' => $districtName]
                );
            }
